...
<form id="commentForm${param.targetUUID}" action="${pageContext.request.contextPath}/submitComment.do" method="post" class="hidden">
    ...
    <div class="flex flex-col">
        <textarea name="commentContent" placeholder="Please be sure to provide a clear and detailed comment to contribute to StoneOverflow." class="textAreaCommentClass h-16 shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mt-1 leading-tight focus:outline-none focus:shadow-outline"></textarea>
    </div>
    <button type="submit" class="submitCommentClass w-auto bg-black text-white font-bold text-lg hover:bg-gray-700 p-2 mt-8">Submit</button>
</form>
