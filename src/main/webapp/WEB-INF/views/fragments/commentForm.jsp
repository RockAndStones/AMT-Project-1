...
<button onClick="showCommentForm(${msg.uuid})" class="font-semibold hover:text-black">Add a comment</button>

<form id="commentForm${msg.uuid}" action="${pageContext.request.contextPath}/submitComment.do" method="post">
