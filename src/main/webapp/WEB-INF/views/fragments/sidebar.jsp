...
<div class="hidden lg:block lg:fixed w-full lg:w-1/5 text-xl text-gray-800 lg:border-r leading-normal">
    <nav id="sidebar" class="mt-10">
        ...
        <a href="home" class="flex items-center py-2 px-8 bg-gray-200 text-gray-900 border-r-4 border-gray-900">
            <i class="h-5 w-5 fas fa-bars"></i>
            <span class="mx-4 font-medium">Questions</span>
        </a>

        <a href="addQuestion" class="flex items-center mt-5 py-2 px-8 text-gray-600 border-r-4 border-white hover:bg-gray-200 hover:text-gray-700 hover:border-gray-700">
