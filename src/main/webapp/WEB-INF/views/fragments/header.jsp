...
<nav id="header" class="bg-white sticky w-full flex flex-wrap justify-between z-10 top-0 py-4 border-b">
    ...
    <div class="w-full flex-grow justify-between px-8 lg:flex lg:w-4/5 lg:content-center lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-0 z-20" id="nav-content">
        <div class="flex-1 w-full max-w-xl content-center py-4 lg:py-0">
            <form name="search-form" method="get" action="${pageContext.request.contextPath}/home" class="relative pull-right">
                <input
                    type="search"
                    placeholder="Search"
                ...
                <div class="absolute search-icon" style="top: 0.5rem;left: 1.2rem; cursor: pointer;" onclick="document.forms['search-form'].submit();">
