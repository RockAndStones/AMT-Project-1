...
public class QuestionFacade {
    ...
    public QuestionsDTO getQuestions(QuestionQuery query) {
        ...
        List<QuestionsDTO.QuestionDTO> allQuestionsDTO = allQuestions.stream().map(question -> QuestionsDTO.QuestionDTO.builder()
                ...
                .date(formatter.format(question.getDate()))
                .type(question.getQuestionType().name()).build()).collect(Collectors.toList());
    ...
    public QuestionsDTO.QuestionDTO getQuestion(QuestionId id) {
        ...
        return question.map(value -> QuestionsDTO.QuestionDTO.builder()
                ...
                .date(formatter.format(value.getDate()))
                .type(value.getQuestionType().name()).build()).orElse(null);
